...
function App() {
  ...
  return (
    <div className="calculator-container">
      <div className="about">
        <h3>Прізвище, імʼя: Бубенко Олексій</h3>
        <h4>Напрямок, за яким планує розвиватись: .NET розробка</h4>
        <h5>Персональна сертифікація: Microsoft Certified Solutions Developer (MCSD)</h5>
        <h6>
          Аргументація: MCSD є доказом знань в таких областях, як розробка веб-додатків, баз даних і хмарних рішень на базі .NET та вимагає глибокого розуміння .NET.
          Вона покаже здатність проектувати, розробляти і підтримувати високоякісні рішення на базі технологій Microsoft.
          Тому сертифікація MCSD круто допоможе довести знання і навички у області .NET та збільшить здатність знайти роботу з високою зарплатою.
        </h6>
      </div>
